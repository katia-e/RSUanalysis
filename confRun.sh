...
lamJac=5; echo Reference point for iterative method if Lambda = $lamJac
...
nTerms=50; echo $nTerms terms will be calculated

# stopCrit defines stopping criteria
stopCrit=0.000001; echo Stopping criteria is $stopCrit #0.000001

# w defines parameter of weighted jacoby
w=0.9; echo method: weighted Jacoby with parameter $w

### Simulaiton parameters
lamMax=20; echo Range of system loads [0...$lamMax]
